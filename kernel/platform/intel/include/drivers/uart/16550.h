#ifndef _KERNEL_PLATFORM_INTEL_DRIVERS_SERIAL_UART_H
#define _KERNEL_PLATFORM_INTEL_DRIVERS_SERIAL_UART_H
...
#endif // _KERNEL_PLATFORM_INTEL_DRIVERS_SERIAL_UART_H
