...
/**
 * Stands for every subtype of a class. No class assigns a subclass of 0xFF, so
 * the value is free to be used as a wildcard when a class is looked up.
 */
#define PCI_SUBTYPE_ANY 0xFF
...
#define PCI_SUBTYPE_SERIAL_INFINIBAND_CONTROLLER 0x06
...
#define PCI_SUBTYPE_WIRELESS_ETHERNET_CONTROLLER 0x20
...
#define PCI_SUBTYPE_SATELLITE_TV_CONTROLLER 0x01
#define PCI_SUBTYPE_SATELLITE_AUDIO_CONTROLLER 0x02
#define PCI_SUBTYPE_SATELLITE_VOICE_CONTROLLER 0x03
#define PCI_SUBTYPE_SATELLITE_DATA_CONTROLLER 0x04

// Subtypes for PCI_TYPE_ENCRYPTION

#define PCI_SUBTYPE_ENCRYPTION_NETWORK_CONTROLLER 0x00
