/**
 * @file keyboard.h
 * @brief Definitions for the keyboard devices.
 * 
 * This file contains structures and definitions for the keyboard devices. This includes the
 * keyboard driver interface and the keyboard event structure. Moreover, it contains definitions
 * for the different keycodes that can be generated by the keyboard and are used instead of the
 * hardware dependent scancodes.
 */
